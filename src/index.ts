...
\outl0\strokewidth0 \strokec2 import \{ DurableObject \} from "cloudflare:workers";\
\
...
\
      ws.onopen = () => \{\
        statusEl.textContent = "Connected \'95 session: " + session;\
      \};\
\
      ws.onclose = () => \{\
        statusEl.textContent = "Disconnected \'96 reconnecting...";\
...
\
    function addEvent(ev) \{\
      ...
      div.className = "event";\
      div.innerHTML = \\`<span class="type">\\$\{ev.type\}</span> \'b7 \\$\{ev.content\}\\`;\
